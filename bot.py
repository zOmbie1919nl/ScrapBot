...
async def superhelp(ctx):
    ...
    em.add_field(name="Selfinfo", value="this will give you basic information about yourself.", inline=False)
    em.add_field(name="Memberinfo [member's mention or id]", value="this will give you basic information about someone else.", inline=False)
    await ctx.send(embed=em)
